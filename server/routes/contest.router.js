...
router.put('/', rejectUnauthenticated, (req, res) => {
    ...
    pool.query(sqlText, [
        ...
        req.body.contestStartDate,
        req.body.contestStartTime,
        req.body.contestEndDate,
        req.body.contestEndTime,
        req.body.contestCompostBin,
        req.body.contestNameId,
    ])
        .then((result) => {
            res.sendStatus(200)
        })
...
router.post('/add', rejectUnauthenticated, (req, res) => {
    console.log('ADD CONTEST: >>>> ', req.body)
