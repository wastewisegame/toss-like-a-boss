                ...
                <div className={this.props.classes.scoreboardHolder}>
                    <header className={this.props.classes.scoreboardBackground}>
                        <div>
                            <Grid container>
                                <Typography
                                    className={this.props.classes.scoreboard}
                                    variant="h1"
                                >
                            ...
                            >
                                ...
                                <Typography
                                    className={
                                        this.props.classes.scoreboardSmallText
                                    }
                                >
                                    Items Remaining:
