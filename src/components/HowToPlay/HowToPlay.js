...
import fifth from '../../img/fifth-slide.png'
            ...
            <div>
                    ...
                    >
                        <div className={this.props.classes.howToDiv}>
                            <h1 className={this.props.classes.header}>
                                1. The game will start with a piece of waste on
                                screen that needs to be sorted
                            </h1>
                            <Button
                ...
                {this.state.pageNumber === 2 && (
                    ...
                    >
                        <div className={this.props.classes.howToDiv}>
                            <h1 className={this.props.classes.header}>
                                2. The player must select the correct bin to
                                place the waste into
                            </h1>
                            <Button
                                className={this.props.classes.button}
                                variant="outlined"
                ...
                {this.state.pageNumber === 3 && (
                    ...
                    >
                        <div className={this.props.classes.howToDiv}>
                            <h1 className={this.props.classes.header}>
                                3. If the player is correct a new item will
                                appear on screen. There will be fifteen items
                                total
                            </h1>
                            <Button
                                className={this.props.classes.button}
                ...
                {this.state.pageNumber === 4 && (
                    ...
                    >
                        <div className={this.props.classes.howToDiv}>
                            <h1 className={this.props.classes.header}>
                                4. If the player places an item in the wrong
                                bin, they must place it in the correct bin to
                                move on.
                            </h1>
                            <Button
                                className={this.props.classes.button}
                ...
                {this.state.pageNumber === 5 && (
                    ...
                    >
                        <div className={this.props.classes.howToDiv}>
                            <h1 className={this.props.classes.header}>
                                5. Points are only awarded if the player gets it
